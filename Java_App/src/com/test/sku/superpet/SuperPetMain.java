...
public class SuperPetMain {
	...
	public static void main(String[] args) {
		...
		while(go) {
			...
			switch(m) {
			case "a": UserIO.addMenu(); break;
			case "s": UserIO.listMenu();
			//case "f": UserIO.findMenu();
			//case "u": UserIO.updateMenu();
			//case "d": UserIO.deleteMenu();
	...
	/*private static void pets() {
		...
		Hamster hamster1 = new Hamster(15000, "Golden Hamster", 2.2F);
		...
		System.out.println("This is your pets !");
		System.out.println("--------------------------------------------------------");
