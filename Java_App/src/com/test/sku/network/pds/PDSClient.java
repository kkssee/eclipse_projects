...
public class PDSClient 
{
	...
	private static void cliDelete() throws Exception {
	...
	private static void cliUpdate() throws Exception {
	...
	private static void cliFind() throws Exception {
	...
	private static void cliDetail() throws Exception{
	...
	private static void cliList() throws Exception{
	...
	private static void cliUpload() throws Exception{
